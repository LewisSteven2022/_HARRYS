      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a href="mailto:hello@harrys.je" className="footer-link text-lime">
                  hello@harrys.je
                </a>
              </li>
              <li>
                <a href="tel:+447700900000" className="footer-link">
                  07700 900000
                </a>
              </li>
            </ul>
          ...
          {/* Opening Hours */}
          <div>
            <h4 className="font-semibold text-white mb-6 text-sm">Opening Hours</h4>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-xs">© {currentYear} Harry's Personal Training. All rights reserved.</p>
