      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <img src="/images/logo.png" alt="Harry's JSY" className="h-12 w-auto" />
            </div>
            <p className="text-gray-500 text-sm mb-6 max-w-sm">
              Jersey&apos;s home of Functional Fitness. Building the ultimate fitness community with impeccable coaching standards and relentless energy.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="text-gray-400">Jersey, Channel Islands</li>
              <li>
        ...
        <div className="mt-16 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-xs">&copy; {currentYear} Harry&apos;s JSY. All rights reserved.</p>
