	...
	const testimonials = [
		{
			...
			quote:
				"Training through pregnancy was one of the best decisions I made. Harry adapted every session to my changing body while still keeping me challenged.",
		},
		{
			name: "Luke Rankin",
			initials: "LR",
			...
			quote:
				"His confidence has grown immensely after completely changing his lifestyle habits and dietary patterns.",
		},
	];
			...
			<section className="relative py-12 sm:py-16 md:py-20 bg-[#111111]">
				<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl">
					...
					<p className="text-gray-400 max-w-2xl text-sm sm:text-base md:text-lg">
						Our clients achieve incredible transformations through consistent
						training, expert coaching, and a supportive community. Here are some
						of their stories.
					</p>
				</div>
			</section>
				...
				<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl">
					<div className="space-y-8 sm:space-y-10 md:space-y-12">
						{testimonials.map((testimonial, index) => (
							<div
								key={index}
								className="card-rounded-lg p-5 sm:p-6 md:p-8 lg:p-12">
								<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
									{/* Left - Profile */}
									<div>
										<div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
											<div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-lime/20 flex items-center justify-center text-lime text-lg sm:text-xl font-bold">
											...
											<div>
												...
												<span className="text-lime text-xs sm:text-sm">
													{testimonial.category}
												</span>
											</div>
										</div>

										<h4 className="font-display text-xl sm:text-2xl text-white tracking-wide mb-3 sm:mb-4">
									...
									<div className="flex items-center">
										<blockquote className="relative">
											<span className="absolute -top-4 -left-2 text-6xl text-lime/20 font-serif">
												&ldquo;
											</span>
				...
				<div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-gray-400 text-lg leading-relaxed mb-8">
							Results at Harry&apos;s aren&apos;t just about the numbers on the
							scale. We focus on building strength, improving movement quality,
							and creating sustainable habits that transform your entire
							lifestyle.
						</p>

						<div className="grid md:grid-cols-3 gap-6 text-left">
							<div className="p-6 border border-gray-800 rounded-xl">
								<h3 className="text-lime font-semibold mb-2">
									Consistent Training
								</h3>
								<p className="text-gray-400 text-sm">
									Show up regularly, and results will follow. Our structured
									programming keeps you accountable.
								</p>
							</div>
							<div className="p-6 border border-gray-800 rounded-xl">
								<h3 className="text-lime font-semibold mb-2">
								...
								<p className="text-gray-400 text-sm">
									Every session is led with impeccable standards and attention
							...
							<div className="p-6 border border-gray-800 rounded-xl">
								...
								<p className="text-gray-400 text-sm">
									Join a pack of like-minded individuals who lift each other up
									every session.
								</p>
							</div>
						</div>
			...
			<section className="section-padding-lg bg-[#111111]">
				<div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl text-center">
					...
					<p className="text-gray-400 max-w-2xl mx-auto mb-8">
						Every transformation starts with a single session. Join the pack and
