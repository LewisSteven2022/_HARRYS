		...
		<>
			...
			<section className="hero-section relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
				...
				<div className="relative z-10 text-center px-4 sm:px-6 w-full">
					{/* Caption */}
					<p className="text-lime text-xs sm:text-sm md:text-base lg:text-lg font-semibold tracking-widest uppercase mb-3 sm:mb-4">
						Functional Fitness
					</p>

					{/* Main title */}
					<h1 className="hero-title mb-4 sm:mb-6">HARRYS</h1>

					{/* Tagline */}
					<p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 mb-2 max-w-2xl mx-auto px-2">
						Jersey&apos;s home of Functional Fitness
					</p>
					<p className="text-xs sm:text-sm md:text-base text-gray-400 mb-8 sm:mb-10 max-w-lg mx-auto px-2">
			...
			<section className="section-padding-lg">
				<div className="container mx-auto px-6 sm:px-8 lg:px-12 max-w-7xl">
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
						{/* Pillar 1 */}
						<div className="card-rounded-lg card-glow p-5 sm:p-6 md:p-8">
							<div className="icon-badge mb-4 sm:mb-6">
								<svg
									viewBox="0 0 24 24"
									fill="none"
									stroke="currentColor"
							...
							<h3 className="font-display text-lg sm:text-xl text-white mb-2 sm:mb-3 tracking-wide">
								Muscle Recruitment
							</h3>
					...
					<div className="mt-8 sm:mt-12 text-center">
						<blockquote className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 italic max-w-3xl mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
						...
						<div className="pricing-card pricing-card-featured">
							<div className="p-4 sm:p-6">
								<h3 className="text-lime font-semibold text-base sm:text-lg mb-2">
									6-Pack Bootcamps
								</h3>
								<div className="price mb-3 sm:mb-4">
					...
					<div className="newsletter-section p-8 md:p-12">
						<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
							<div className="max-w-md">
								<h2 className="font-display text-3xl md:text-4xl tracking-wide mb-3">
								...
								<form
									...
									<div className="relative flex-1">
										...
										<input
											...
											className="w-full pl-12 pr-4 py-3 rounded-full text-sm focus:outline-none transition-colors"
											suppressHydrationWarning
										/>
									</div>
									<button
										type="submit"
										className="px-8 py-3 rounded-full font-semibold text-sm tracking-wider uppercase transition-colors whitespace-nowrap"
										suppressHydrationWarning>
										Sign Up
									</button>
								</form>
