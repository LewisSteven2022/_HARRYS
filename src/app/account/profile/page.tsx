	...
	if (loading) {
		return (
			<div className="py-8 sm:py-12 md:py-16">
				<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-2xl">
		...
		<div className="py-8 sm:py-12 md:py-16">
			<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-2xl">
				...
				<div className="mb-6 sm:mb-8">
					<Link
						href="/account"
						className="text-gray-400 hover:text-lime text-xs sm:text-sm mb-3 sm:mb-4 inline-flex items-center gap-2">
						<svg
							className="w-4 h-4"
							fill="none"
							stroke="currentColor"
					...
					<div className="flex items-center mt-4">
						...
						<h1 className="font-display text-2xl sm:text-3xl md:text-4xl text-white tracking-wide">
							EDIT PROFILE
						</h1>
					</div>
				</div>
