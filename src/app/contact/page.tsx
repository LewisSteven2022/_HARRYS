	...
	return (
		<div className="section-padding-lg">
			<div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 max-w-7xl">
				<h1 className="font-display text-3xl sm:text-4xl md:text-5xl text-white tracking-wide mb-8 sm:mb-12">
					Get In Touch
				</h1>

				<div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 max-w-4xl">
					{/* Contact Info */}
					<div>
						...
						<div className="space-y-4 sm:space-y-6">
							<div>
								...
								<p className="text-white">*To Be Confirmed*</p>
							</div>
							<div>
								<p className="text-gray-400 mb-2">Email</p>
								<a
									href="mailto:hello@harrys.je"
									className="text-lime hover:text-lime-dark">
									hello@harrys.je
								</a>
							</div>
							<div>
